...
opt<-list(inputDir="~/tgldev2/results/cfMeDIP/docker/output/CMP-01-03-cfDNA-03_new3.bowtie2.filtered.dedup.bam",outputDir="~/tgldev2/results/cfMeDIP/docker/output",windowSize=200)
